...
function cropCanvasToContentWithPadding(
...
export default () => {
  ...
  // State to control the instructions popup (visible immediately on launch)
  ...
  const getNextResponse = async (
    ...
    const query =
      "You are an educational assistant helping students with homework problems.\n" +
      ...
      "Do not hallucinate any information, only provide feedback on what they have written.\n" +
